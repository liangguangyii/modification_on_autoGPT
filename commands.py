...
def google_official_search(query, num_results=8, proxy='your_proxy'):
    ...
    try:
        ...
        # Set up proxy for the requests library
        session = get_request_session(proxy)
